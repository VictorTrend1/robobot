...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 0.04427519972473025; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -0.07884241387088349; // x position of the perpendicular encoder (in tick units)
    }
