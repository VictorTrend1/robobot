...
public final class trajectory_Interpolation {
    ...
    public static final double D1 = 40.0;
    public static final double D2 = 70.0;
    public static final double D3 = 100.0;
    public static final double D4 = 130.0;

    public static final double RPM1 = 3200.0;
    public static final double RPM2 = 3800.0;
    public static final double RPM3 = 4500.0;
    public static final double RPM4 = 5200.0;
